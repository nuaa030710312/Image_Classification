...
class BasicBlock(nn.Module):
    ...
    def __init__(self,in_channle,out_channel,stride=1,downsample=None,**kwargs):
        super(BasicBlock, self).__init__()
        self.conv1=nn.Conv2d(in_channle,out_channel,kernel_size=3,stride=stride,padding=1,bias=False)
